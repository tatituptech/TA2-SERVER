        ...
        while true do
            ...
            if isDriver then
                ...
                if drivingDistance[plate] then
                    TriggerServerEvent('ta2-mechanicjob:server:updateDrivingDistance', plate, drivingDistance[plate].distance)
                    TriggerServerEvent('ta2-mechanicjob:server:updateVehicleComponents', plate, vehicleComponents[plate])
                end
                plate = nil
                vehicle = nil
                break
