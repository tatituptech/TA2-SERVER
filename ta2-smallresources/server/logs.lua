...
RegisterNetEvent('ta2-log:server:CreateLog', function(name, title, color, message, tagEveryone, imageUrl)
...
TA2Core.Commands.Add('testwebhook', 'Test Your Discord Webhook For Logs (God Only)', {}, false, function()
    TriggerEvent('ta2-log:server:CreateLog', 'testwebhook', 'Test Webhook', 'default', 'Webhook setup successfully')
end, 'god')
