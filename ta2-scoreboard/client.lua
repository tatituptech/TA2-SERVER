...
RegisterNetEvent('ta2-scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            TA2Core.Functions.TriggerCallback('ta2-scoreboard:server:GetScoreboardData', function(players, cops, playerList)
