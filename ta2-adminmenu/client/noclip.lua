...
ToggleNoClip = function(state)
    ...
    TA2Core.Functions.Notify(IsNoClipping and Lang:t('success.noclip_enabled') or Lang:t('success.noclip_disabled'))
...
RegisterNetEvent('ta2-admin:client:ToggleNoClip', function()
