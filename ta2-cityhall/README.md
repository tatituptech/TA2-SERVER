# ta2-cityhall
City Services for TA2-Core Framework
...
- [ta2-target](https://github.com/BerkieBb/qb-target) - For Interaction (Optional)
- [ta2-phone](https://github.com/qbcore-framework/qb-phone) - For E-Mail
...
- ta2-target integration, this is optional
- PolyZone and ta2-core DrawText integration, this is optional
