    ...
    if event == 'CEventNetworkEntityDamage' then
        ...
        if victimDied and NetworkGetPlayerIndexFromPed(victim) == PlayerId() and IsEntityDead(PlayerPedId()) then
            ...
            elseif InLaststand and not isDead then
                ...
                local weaponLabel = (TA2Core.Shared.Weapons and TA2Core.Shared.Weapons[weapon] and TA2Core.Shared.Weapons[weapon].label) or 'Unknown'
                local weaponName = (TA2Core.Shared.Weapons and TA2Core.Shared.Weapons[weapon] and TA2Core.Shared.Weapons[weapon].name) or 'Unknown'
                TriggerServerEvent('ta2-log:server:CreateLog', 'death', Lang:t('logs.death_log_title', { playername = playerName, playerid = GetPlayerServerId(playerid) }), 'red', Lang:t('logs.death_log_message', { killername = killerName, playername = playerName, weaponlabel = weaponLabel, weaponname = weaponName }))
