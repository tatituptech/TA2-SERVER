...
RegisterNetEvent('ta2-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('ta2-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('ta2-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	TA2Core.Functions.Notify(message, color)
end
